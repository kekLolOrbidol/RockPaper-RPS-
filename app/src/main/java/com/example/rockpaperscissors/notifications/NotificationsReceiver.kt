...
import com.example.rockpaperscissors.ui.MainActivity

class NotificationsReceiver : BroadcastReceiver() {

    override fun onReceive(context: Context, intent: Intent) {
        val type = intent.getIntExtra(Push.TYPE_EXTRA, 0)
        ...
        val nm = Push().getNotificationManager(context)
    ...
    fun buildNotification(context: Context, pendingIntent: PendingIntent?, nm: NotificationManager?): NotificationCompat.Builder {
        ...
        return NotificationCompat.Builder(context, "default")
            ...
            .setContentTitle("Бонуcи чeкають на тeбе! Захoдь та вигpавай!!")
            .setAutoCancel(true)
    }
}